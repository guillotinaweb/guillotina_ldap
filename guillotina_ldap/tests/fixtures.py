...
def base_settings_configurator(settings):
    ...
    settings["auth_user_identifiers"] = ["guillotina_ldap.user.LDAPUserIdentifier"]
...
LDAPCONFIG = {"host": None, "port": None}
...
def ldap():
    ...
    client.set_credentials(
        "SIMPLE", user="cn=admin,dc=my-company,dc=com", password="secret"
    )
    conn = client.connect()
